...
describe("HeroImage component", () => {
  test("renders hero image and title", () => {
    render(<HeroImage src="/happy.jpg" alt="Be Happy" title="Stay Happy Always" />);
    expect(screen.getByText("Stay Happy Always")).toBeVisible();
  });

  test("applies disabled style", () => {
    render(<HeroImage src="/happy.jpg" alt="Be Happy" title="Disabled" disabled data-testid="hero-wrapper" />);
